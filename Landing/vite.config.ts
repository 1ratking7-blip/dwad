  ...
  build: {
    rollupOptions: {
      ...
      input: {
        ...
        hallOfFameIndex: resolve(__dirname, 'hall-of-fame/index.html'),
        hallOfFameEn: resolve(__dirname, 'hall-of-fame/en/index.html'),
        hallOfFameVi: resolve(__dirname, 'hall-of-fame/vi/index.html'),
