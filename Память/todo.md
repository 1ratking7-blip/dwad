...
- `Scripts/posts/schedule_2026-07-19_to_2026-07-28.md` — график постов ждёт вашего согласования (там же прямой вопрос про облачную routine, публикующую в канал в 19:00 — уточнить, не дублирует ли она этот план)
- `SalesAgent/src/messages/config.mjs` — заполнить реальное имя/услугу/контакт (сейчас "ВАШЕ ИМЯ"), иначе 5 готовых черновиков нельзя отправлять как есть
