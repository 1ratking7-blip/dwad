...
- Ветка `feature/interactive-alive-site` (пасхалки/достижения/курсор/частицы, сессия 2026-07-27_003) — создана из main (уже включает смерженный luxury/hero-редизайн из сессии 002, который сам уже смержен+запущен+задеплоен). Ждёт визуальной проверки пользователем и явного решения смержить/запушить/задеплоить.
