...
- Ветка `feature/premium-dark-hero` (полный редизайн Hero, сессия 2026-07-27_002) ждёт визуальной проверки пользователем и явного решения смержить/запушить/задеплоить.
